...
var statuses = __webpack_require__(86)
...
var debug = __webpack_require__(170)("follow-redirects");
...
var _fetchData = __webpack_require__(157);
...
var index = _fs2.default.readFileSync("index.html", "utf-8");

app.get("**", function (req, res) {
  (0, _fetchData2.default)().then(function (data) {
    var html = (0, _server.renderToString)(_react2.default.createElement(_App2.default, { postData: data }));
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(28).concat(__webpack_require__(44)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(45).concat(__webpack_require__(108)) },
...
var deprecate = __webpack_require__(4)('express');
var isIP = __webpack_require__(42).isIP;
var typeis = __webpack_require__(11);
var http = __webpack_require__(8);
var fresh = __webpack_require__(60);
var parseRange = __webpack_require__(61);
...
var k=__webpack_require__(24),r=__webpack_require__(23),aa=__webpack_require__(13),t=__webpack_require__(25),ba=__webpack_require__(64),ca=__webpack_require__(65),da=__webpack_require__(5);
...
var App = function App(_ref) {
  ...
  var posts = postData.map(function (el, i) {
...
var fetchData = function fetchData() {
  return (0, _axios2.default)("https://jsonplaceholder.typicode.com/posts").then(function (res) {
    return res.data;
  });
};
...
try {
  var supportsColor = __webpack_require__(173);
